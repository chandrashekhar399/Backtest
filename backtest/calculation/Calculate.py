...
class Calculation:
    ...
    def __enter__(self):
        self.conn = pyodbc.connect('DRIVER={ODBC Driver 11 for SQL Server};SERVER=65.0.33.214;DATABASE=FDS_Datafeeds;UID=sa;PWD=Indxx@1234',connect_timeout=1200000)
    ...
    def Validate_Read_CSV(self,file_Name,IDentifier,tax_file_Name):
        print('Validate_Read_CSV start at Calculate')        
        data = pd.read_excel(file_Name, header=None)   
        a = data.values.tolist()
        d1 = {}
        d2 = {}
