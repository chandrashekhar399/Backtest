...
def Check_Ric(ric_data):
    ...
    ric_active_data= {}
    connection = ms.connect('DRIVER={ODBC Driver 11 for SQL Server};SERVER=3.7.99.191;DATABASE=TR_Datafeeds;UID=sa;PWD=Indxx@1234')
...
def Get_TAX():
    connection = ms.connect('DRIVER={ODBC Driver 11 for SQL Server};SERVER=15.207.231.163;DATABASE=Backtest;UID=sa;PWD=Indxx@1234')
